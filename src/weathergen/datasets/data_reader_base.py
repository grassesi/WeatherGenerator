...
class ReaderData:
    ...
    The freezing prevents rebinding, but the arrays themselves stay writable.Preferrable copy arrays before modification and rebind using `dataclasses.replace`.
    """
